  ...
  return (
    <div className="maaya-home">
      ...
      <div className="quick-actions">
        ...
        <button className="qa-btn" style={{ '--qa': 'var(--karma)' } as React.CSSProperties} onClick={() => onNavigate('karma')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
          Track Habit
        </button>
        <button className="qa-btn" style={{ '--qa': 'var(--sutra)' } as React.CSSProperties} onClick={() => onNavigate('sutra')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
          Add Document
        </button>
      </div>
      ...
      <div className="card maaya-activity">
        <div className="activity-list">
          ...
          {['Vitara','Karma','Sutra'].map((m, i) => {
            const colors: Record<string,string> = { Vitara:'var(--vitara)', Karma:'var(--karma)', Sutra:'var(--sutra)' };
            return (
