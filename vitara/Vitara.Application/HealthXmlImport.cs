...
public static class HealthXmlImport
{
    ...
    //
    // The 810MB export contained a "resting heart rate" of 176, a night totalling 0.5
    // minutes and another totalling 928. None of those are measurements; they are an
