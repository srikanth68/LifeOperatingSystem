...
struct SettingsView: View {
    ...
    @AppStorage("serverHost") private var serverHost = "<your-mesh-ip>"
        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("Reachable over NordVPN Meshnet or Tailscale (e.g. <your-mesh-ip>). Each module is served on its own port off this host. The Device Key matches DEVICE_API_KEY on the server for the telemetry/HealthKit uploads.")
                        .font(.caption)
                }
